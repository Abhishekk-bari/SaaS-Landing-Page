...
export const Hero = () => {
  ...
  return (
    <div className="bg-black relative overflow-clip sm:py-24 text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[74px]">
      ...
      <a href="#" className="inline-flex gap-3 border py-2 px-2 rounded-lg border-white/30">
      ...
      <h1 className='text-7xl sm:text-9xl font-bold tracking-tighter text-center inline-flex'>One Task 
        <br /> At A Time
      </h1> 
